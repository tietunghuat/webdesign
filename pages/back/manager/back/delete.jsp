...
<%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
 ...
 <%
        ...
        try{
            ...
            String deletUser="delete from dbbasketball.merchandise where merchandise.ball_number='"+delete+"'";
...
<body>
	...
	<%}catch(SQLException e){
			...
			out.print("請<a href='backstage.jsp'>按此</a>回系統!!");}%>
			 ...
			 <%try{
            Statement stmt=conn.createStatement();
            String deletmember="delete from dbbasketball.member where member.username='"+delete+"'";
