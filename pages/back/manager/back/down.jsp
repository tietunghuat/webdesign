...
try{
           ...
           String sql9=" update basketball.basketball_pages set name='"+name+"' where ball_name='"+ball_name+"'";
           stmt.executeUpdate(sql9); 
		   String sql8=" update basketball.basketball_pages set price='"+price+"' where ball_name='"+ball_name+"'";
           stmt.executeUpdate(sql8); 
		   String sql7=" update basketball.basketball_pages set quantity='"+quantity+"' where ball_name='"+ball_name+"'";
           stmt.executeUpdate(sql7); 
		   String sql6=" update basketball.basketball_pages set venue='"+venue+"' where ball_name='"+ball_name+"'";
