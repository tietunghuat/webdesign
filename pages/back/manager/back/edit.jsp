...
<%
					String sql1 = "SELECT * FROM dbbasketball.basketball_pages";
					...
					while (rs.next()) {
						...
						ball_name = rs.getString("ball_name");
...
%>
            ...
            <tr>
                ...
                <td><input type="text" name="venue" value="<%=rs.getString("venue")%>"></td>
                <td>
                <button class="button2"><input type="text" name="ball_name" value="<%=rs.getString("ball_name")%>" hidden>完成編輯</button></a>
                <form action="delete.jsp"><button class="button2" onclick="ooxx()"><input type="text" name="delete" value="<%=rs.getString("ball_name")%>" hidden>刪除資料</button></form>
                </td>
            </tr>
			</form>
			<%}%>
