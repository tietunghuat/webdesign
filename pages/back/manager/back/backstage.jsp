...
<%
					String sql1 = "SELECT * FROM dbbasketball.merchandise";
...
%>
	...
	<div>
        <table>
			...
			<%
			String sql2 = "SELECT * FROM dbbasketball.member";
            ...
            <tr>
                ...
                <td>
                <a href="edit.jsp"> <button class="button2"><input type="text" name="ball_number" value="<%=rs1.getString("id")%>" hidden>編輯資料</button></a>
